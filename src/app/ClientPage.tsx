...
function useCtaConfig(platform: Platform) {
  return useMemo(() => {
    switch (platform) {
      case "ios": return { href: APP_STORE, heroLabel: "Download for iPhone", navLabel: "Get the App", mobileLabel: "Download Glovebox", external: true };
      case "android": return { href: PLAY_STORE, heroLabel: "Get it on Google Play", navLabel: "Get the App", mobileLabel: "Download Glovebox", external: true };
      default: return { href: "/trip", heroLabel: "Open Glovebox", navLabel: "Open Glovebox", mobileLabel: "Open Glovebox", external: false };
    }
  }, [platform]);
}
...
const FEATURES = [
  ...
  { icon: Fuel, num: "02", title: "Never miss a servo", body: "See every fuel stop between here and there. Glovebox flags the gaps where your tank won\u2019t make it, before you\u2019re stranded." },
...
const STEPS = [
  { t: "Drop your stops", d: "Tell Glovebox where you\u2019re headed. It finds the route, every fuel station, and checks for road closures." },
  { t: "Tap download", d: "One button saves your whole trip. Maps, directions, fuel plan, and warnings stay on your phone." },
  { t: "Hit the road", d: "Voice directions and fatigue reminders work 100% offline. Glovebox handles the dead zones." },
];
        ...
        <div className="rl-inner">
          <div className="rl-problem-grid">
            <div className="rl-problem-text">
              ...
              <p>Most nav apps need the cloud. Glovebox downloads everything to your phone before you leave so it&apos;s useful the whole way.</p>
            </div>
      ...
      <section className="rl-download" id="download">
        <div className="rl-inner">
          <div className="rl-download-card">
            ...
            <p>The outback is no place for a loading wheel. Get Glovebox and plan your first trip today.</p>
            ...
            {platform === "desktop" && <a href="/trip" className="rl-download-web">Or use Glovebox in your browser <ArrowRight size={14} /></a>}
          </div>
        </div>
      </section>
        ...
        <div className="rl-inner">
          <div className="rl-footer-grid">
            <div className="rl-footer-left">
              <div className="rl-footer-logo"><Compass size={16} /> <strong>GLOVEBOX</strong></div>
