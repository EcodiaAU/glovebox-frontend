    ...
    <>
      ...
      <section className={s.section}>
        <p className={s.text}>
          ...
          Nav navigation application and all associated services (the
          &quot;Service&quot;), operated by Ecodia Pty Ltd (ABN: 89693123278), a
          company registered in Queensland, Australia (&quot;we&quot;,
          &quot;us&quot;, &quot;our&quot;).
        </p>
        <p className={s.text}>
          By downloading, installing, or using Nav, you agree to be bound by
          these Terms. If you do not agree, do not use the Service.
        </p>
        <div className={s.highlight}>
          <p>
            <strong>Important safety notice:</strong> Nav is a navigation aid.
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Nav provides trip planning, turn-by-turn navigation, offline mapping,
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          ...
          Service. By using Nav, you represent that you meet this age
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          You may use some features of Nav without an account. Creating an
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          ...
          gaps, or inaccuracies. The absence of an alert in Nav does not mean a
          road is safe.
        </p>
        <div className={s.highlight}>
          <p>
            <strong>Always check official sources</strong> before travelling in
            remote areas. Nav supplements but does not replace official road
        ...
        <p className={s.text}>
          ...
          areas, and never rely solely on Nav for fuel planning.
        </p>
        ...
        <p className={s.text}>
          When used offline, Nav relies on previously cached data. This data
          ...
          only available within pre-downloaded corridor areas. Nav will clearly
        ...
        <ul className={s.list}>
          <li>
            Nav is a navigation aid, not a definitive source of road
            information.
          </li>
          <li>
          ...
          <li>
            You should not interact with the Nav interface while driving. Use
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          The Nav application, including its design, code, algorithms,
        ...
        <p className={s.text}>
          Nav uses open-source software components including but not limited to
        ...
        <p className={s.text}>
          ...
          provided for use within Nav only.
        </p>

        <h3 className={s.subsectionTitle}>6.4 Your content</h3>
        <p className={s.text}>
          You retain ownership of any content you create in Nav (trip plans,
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          If Nav includes an SOS or emergency feature, it is provided as a
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Nav allows you to share trip plans with other users via invite codes.
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Nav incorporates data and services from third parties, including
        ...
        <p className={s.text}>
          ...
          policies. Your use of Nav constitutes acceptance of the terms of
