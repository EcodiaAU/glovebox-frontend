    ...
    entries: [
      {
        ...
        description:
          "Large language model API powering the Nav Guide for trip planning suggestions, local knowledge, and route recommendations.",
      },
      {
        name: "Tavily",
        ...
        description:
          "Web search API providing the Nav Guide with up-to-date information on road conditions, local events, and regional knowledge.",
      },
      {
        ...
        description:
          "Web search fallback providing supplementary search results for the Nav Guide. © Google.",
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        description:
          "Payment processing for Nav Untethered web purchases.",
      },
      {
        name: "RevenueCat",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        licence: "MIT",
        description: "Python web framework powering the Nav backend API.",
      },
      {
        name: "Pydantic",
  ...
  return (
    <>
      ...
      <p className={s.effectiveDate}>
        Nav is built on the shoulders of open-source communities
      </p>

      <section className={s.section}>
        <p className={s.text}>
          Nav uses the following open-source software, open data, public data
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          ...
          Nav also uses numerous smaller libraries and dependencies, each
        ...
        <div className={s.highlight}>
          <p>
            ...
            Nav is using your work in a way that does not comply with your
