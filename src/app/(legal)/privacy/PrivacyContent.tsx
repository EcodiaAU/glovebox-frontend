  ...
  return (
    <>
      ...
      <section className={s.section}>
        <p className={s.text}>
          Glovebox is operated by Ecodia Pty Ltd (ABN: 89693123278), a company
        ...
        <p className={s.text}>
          ...
          applies to the Glovebox mobile application, the Glovebox web application, and
          any associated APIs and services (collectively, the
          &quot;Service&quot;).
        </p>
        <div className={s.highlight}>
          <p>
            <strong>Glovebox is built offline-first.</strong> The vast majority of
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Location data is central to Glovebox&apos;s navigation functionality. We
        ...
        <ul className={s.list}>
          ...
          <li>
            ...
            Navigation&quot;, Glovebox requests background location permission so
        ...
        <p className={s.text}>
          Glovebox does not store a breadcrumb trail of your past positions. We do
        ...
        <p className={s.text}>
          ...
          device&apos;s system settings. Glovebox will continue to function for trip
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Glovebox stores the following data locally on your device using IndexedDB
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Glovebox uses the following third-party services. We only share the
      ...
      <section className={s.section}>
        ...
        <p className={s.text}>
          Glovebox is designed for use in Australia. If you access the Service from
