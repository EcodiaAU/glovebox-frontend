            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                <div style={{
                  ...
                  <img src="/img/roam-app-icon.png" alt="Nav" width={40} height={40} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                <div>
                  ...
                  <div key={`${m.role}_${idx}`} style={{ animation: "guideFadeIn 0.3s ease" }}>
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <img src="/img/roam-app-icon.png" alt="Nav" width={28} height={28} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                      </div>
